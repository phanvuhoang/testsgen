...
export async function PATCH(
  ...
  const updated = await db.gameshow.update({
    ...
    data: {
      ...
      ...(body.wheelSegments !== undefined ? { wheelSegments: parseInt(body.wheelSegments) || 8 } as any : {}),
      ...(body.wheelMinPoints !== undefined ? { wheelMinPoints: parseInt(body.wheelMinPoints) || 100 } as any : {}),
      ...(body.wheelMaxPoints !== undefined ? { wheelMaxPoints: parseInt(body.wheelMaxPoints) || 1000 } as any : {}),
      ...(body.wheelDeductOnWrong !== undefined ? { wheelDeductOnWrong: !!body.wheelDeductOnWrong } as any : {}),
      ...(body.deductOnWrong !== undefined ? { deductOnWrong: !!body.deductOnWrong } as any : {}),
      ...(body.allowOthersOnIncorrect !== undefined ? { allowOthersOnIncorrect: !!body.allowOthersOnIncorrect } as any : {}),
